...
#Script che si collega alle iDRAC e cambia la password dell'utente root in F0rz4CR!
...
while ($count < 17)
{
        ...
        {
                my $pwd  = " racadm config -g cfgUserAdmin -o cfgUserAdminPassword -i $count F0rz4CR! ";
